require([
    ...
    'underscore/utility/constant',
    'underscore/utility/property',
    'underscore/utility/random',
    'underscore/utility/uniqueId',
    'underscore/utility/times',
    'underscore/utility/escape',
    'underscore/utility/unescape',
    'underscore/utility/template',
    'underscore/utility/result',
], function (clone, isEqual, functions, range, uniq, each, every, some, identity, constant, property,
    random, uniqueId, times, escape, unescape, template, result) {
    ...
    $(document).ready(function() {
        ...
        // warning: mixin is not supported in modularjs-underscore
//        test("mixin", function() {
//            _.mixin({
