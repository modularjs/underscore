require([
    ...
    'underscore/collections/reduce',
    'underscore/collections/toArray',
    ...
    'underscore/objects/isNaN',
    'underscore/objects/clone',
    'underscore/objects/isEmpty',
    'underscore/objects/isElement',
    ...
    'underscore/objects/isBoolean',
    'underscore/objects/isFunction',
    'underscore/objects/isDate',
    'underscore/objects/isRegExp',
    'underscore/objects/isFinite',
    'underscore/objects/isNull',
    'underscore/objects/isUndefined',
    'underscore/objects/tap',
    'underscore/objects/has',
], function (each, map, reduce, toArray, last, functions, keys, values, pairs, invert, isEqual, extend, pick, omit, defaults, isNaN,
             clone, isEmpty, isElement, isArguments, isObject, isArray, isString, isNumber, isBoolean, isFunction,
             isDate, isRegExp, isFinite, isNull, isUndefined, tap, has) {
    ...
    $(document).ready(function() {
        ...
        test("isEqual", function() {
            ...
            // Chaining.
            // WARNING: not supported in modularjs-underscore
...
//            equal(_.isEqual(a.isEqual(b), _(true)), true, '`isEqual` can be chained');
        ...
        // warning: chaining is not supported
//        test("tap", function() {
