require([
    ...
    'underscore/collections/reduceRight',
    ...
    'underscore/collections/findWhere',
    ...
    'underscore/collections/countBy',
    'underscore/collections/shuffle',
    ...
    'underscore/arrays/sortedIndex',
], function (
    functions,
    each, contains, map, reduce, reduceRight, toArray, find, filter, reject, every, some, invoke, pluck, where,
    findWhere, max, min, sortBy, groupBy, indexBy, countBy, shuffle, sample, size,
    isArray, keys, isUndefined, range, sortedIndex) {
