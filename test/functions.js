require([
    ...
    'underscore/functions/memoize',
    'underscore/functions/delay',
    'underscore/functions/defer',
    'underscore/functions/throttle',
    'underscore/functions/debounce',
    'underscore/functions/once',
    'underscore/functions/wrap',
    'underscore/functions/compose',
    'underscore/functions/after'
], function (placeholder, functions, each, map, toArray, bind, bindAll, partial, memoize,
             delay, defer, throttle, debounce, once, wrap, compose, after) {
    ...
    $(document).ready(function () {
        ...
        test("partial", function () {
            ...
            obj.func = _.partial(func, placeholder, 'b', placeholder, 'd');
